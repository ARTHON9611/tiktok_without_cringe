...
class _videoPlayerState extends State<videoPlayer> {
  ...
  void initState() {
    ...
    super.initState();
    videoPlayerController = CachedVideoPlayerController.network(widget.videoUrl)..initialize().then((value){videoPlayerController?.play();videoPlayerController?.setVolume(1);});
  }
  @override
  void dispose() {
